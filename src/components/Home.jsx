...
function Home( {chosenDifficulty, setChosenDifficulty, chosenMode, setChosenMode, isInGame, setIsInGame} ) {
    ...
    return (
    <>
        <Container className="hero text-center pt-5" fluid>
            <Row>
                <Col>
        ...
        <Container className="text-center pt-5" fluid>
            <Row>
                ...
                <p className="how-to-play-text">After pressing play, read the tooltip up top and memorize the positions of the named items.<br/>After, test your memory by clicking the boxes with the previously named items!</p>
            </Row>
            <div className="py-1"/>
            <Row>
            ...
            <Row>
                <Col>
                    <Button className="play--descriptor-label" onClick={onClickPlay}>PLAY</Button>
                </Col>
            </Row>
        </Container>
    </>
